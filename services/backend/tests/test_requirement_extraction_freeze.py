...
HISTORICAL_NO_BASELINE_RELEASE_EXTRACTOR_VERSION = "requirement-extractor-v42.95"
...
def test_requirement_extraction_versions_remain_frozen_for_mvp() -> None:
    ...
    assert MVP_FROZEN_EXTRACTOR_VERSION == HISTORICAL_NO_BASELINE_RELEASE_EXTRACTOR_VERSION
