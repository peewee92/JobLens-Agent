...
- PDF/DOCX 文本摄取、文件隐私边界与 Web 上传已完成；Eval Run/Case Result、`profile-eval-gate-v1`、baseline 对比和只读 API 已完成；下一步是带真实凭据的 Provider Eval 与人工失败案例审查。Fixture 通过仍不代表生产模型质量。
