...
- `collector-requirement-review-dataset.schema.json` — Collector v1.4.4 导出的 Requirement 人工质量验收数据集；只包含具备岗位职责/任职条件证据、无页面噪声、无招聘者尾部且经过近重复去重的 `full_jd` 岗位，20 条独立样本齐备才标记 `ready`
